...
insert into expectation (offer_id, required, order_number, description)
    values (1, false, 0, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt');
insert into expectation (offer_id, required, order_number, description)
    values (1, true, 1, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam');
insert into expectation (offer_id, required, order_number, description)
    values (1, false, 2, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.');
insert into expectation (offer_id, required, order_number, description)
    values (1, true, 3, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim');
insert into expectation (offer_id, required, order_number, description)
    values (1, false, 4, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim');

insert into offer_advantage (offer_id, order_number, description)
    values (1, 0, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam');
insert into offer_advantage (offer_id, order_number, description)
...
insert into offer_advantage (offer_id, order_number, description)
    values (1, 2, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod');
insert into offer_advantage (offer_id, order_number, description)
    values (1, 3, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna');
